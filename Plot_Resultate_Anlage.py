...
Pfad_Plot = inputs['Pfad_Plot_Poster']
...
df_Plot = df.nsmallest(4, 'Anlagekosten mit Li-Batterie [CHF]', keep='all')
...
ax1.set_xticks(np.arange(250, 540, 20))

ax1.set_ylabel('Systemkosten [CHF]', color='#C20078', labelpad=5)
ax1.tick_params(axis='y', colors='#C20078')
ax1.set_yticks(np.arange(800, 1020, 20))
mpl_axes_aligner.shift.yaxis(ax=ax1, org=800 , pos=0)
...
ax1_sek.set_yticks(np.arange(440, 760, 20))
mpl_axes_aligner.shift.yaxis(ax=ax1_sek, org=440 , pos=0)
